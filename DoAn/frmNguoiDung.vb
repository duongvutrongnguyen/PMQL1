Public Class frmNguoiDung
    ...
    Private Sub frmNguoiDung_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim sql As String = "select nd_ma, tk_ten_dang_nhap, ltk_ten, nd_ho_ten, nd_dia_chi, nd_nam_sinh, tk_ma, tk_mat_khau, tk_ma_loai, ltk_ma, nd_ma_tai_khoan, nd_xoa
        ...
        dgvDSNguoiDung.Columns(7).Visible = False
    End Sub
End Class